...
<html>
    ...
    <body>
        ...
        <div id="content">
            ...
            ?>
            <h1 style="background-color:rgb(10, 121, 110); color:white; overflow:hidden; margin:0px;padding:5px">User Requests<a class="button1" style="text-decoration:none;float:right;font-size:20px; margin:5px; color:rgb(10, 121, 110);" href="../connection/logout.php">Log out</a>  </h1>  
